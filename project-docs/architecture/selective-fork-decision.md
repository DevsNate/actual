...
The modified React site and lightly modified stock iOS application use one
canonical semantic command layer and one PostgreSQL budgeting authority. The
site uses a native web API. The iOS app uses a YNAB-shaped compatibility
gateway over the same commands and state.
...
6. React web query and command API
7. Evidence-backed compatibility fixture suite
